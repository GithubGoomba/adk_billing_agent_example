"""Basic BigQuery Billing table agent.

This agent is responsible for orchestrating the analysis of billing data to provide
insights into cloud financial operations (FinOps). It leverages expert subagents
to perform tasks like data retrieval, analysis, and reporting.
"""
